<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CourseDetails.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.CourseDetails" %>
...
<!-- Latest compiled JavaScript -->
  ...
  <ul class="dropdown-menu">
      ...
      <li><a data-toggle="modal" href="#assignment">
          الواجبات
      </a></li>
      <li><a data-toggle="modal" href="#">
          تقييم الدورة
                            ...
                            <form action="#">
                               ...
                               <div class=" row form-group">
                                     <div class="col-md-3 col-sm-12">
                                         <label> محتوى النشاط       </label>
                                     </div>

                                     <div class="col-md-9 col-sm-12">
                                         <input  dbcolumn="start_time" type="text" id="Text2"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                              <div id="divFormTable">
                                     ...
                                     <div class="col-md-9 col-sm-12">
                                         <input onkeypress="return isNumber(event);" dbcolumn="lecture_code" type="text" id="Text1"
                                             class="form-control" runat="server" clientidmode="Static" />
                                  ...
                                  <div class=" row form-group">
                                     ...
                                     <div class="col-md-9 col-sm-12">
                                         ...
                                         <div class="fancy-form" id="divdate1">
                                             <input dbcolumn="dt_hj" type="hidden" id="date_hj" />
                                             <input dbcolumn="dt_m" type="hidden" id="date_m" />
                                   ...
                                   <div class=" row form-group">
                                     ...
                                     <div class="col-md-9 col-sm-12">
                                         <input  dbcolumn="start_time" type="text" id="startTime"
                                             class="form-control" runat="server" clientidmode="Static" />
                                ...
                                <div class=" row form-group">
                                     ...
                                     <div class="col-md-9 col-sm-12">
                                         <input onkeypress="return isNumber(event);" dbcolumn="hall_id" type="text" id="hallNum"
                                             class="form-control" runat="server" clientidmode="Static" />
                        ...
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" class="btn btn-primary" onclick="addLecture();">اضافه </button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="note_edit" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div id="divformNote">
                                <div class=" row form-group">
                                     ...
                                     <div class="col-md-9 col-sm-12">
                                         <input  dbcolumn="NoteContent" type="text" id="NoteContent"
                                             class="form-control" runat="server" clientidmode="Static" />
                        ...
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" class="btn btn-primary" onclick="AddNote();">حفظ </button>
                        </div>
                    </div>
                </div>
            </div>
