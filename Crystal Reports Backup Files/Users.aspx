                                     ...
                                     <%--   <div id="SavedivLoader" class="loader" style="display: none; text-align: center;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:TextBox SkinID="form-control" class="form-control" dbColumn="full_name" ClientIDMode="Static" ID="TextBox1" runat="server">
                                                    </asp:TextBox>
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:TextBox  SkinID="form-control" class="form-control" dbColumn="User_Name" ClientIDMode="Static" ID="txtContactInfo" runat="server">
                                                    </asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtContactInfo"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3 col-sm-12">
                                                    <label class="required">البريد الإلكترونى</label>
                                                </div>
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:TextBox SkinID="form-control" class="form-control" required dbColumn="User_Email" ClientIDMode="Static" ID="TextBox2" runat="server">
                                                    </asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                 ...
                                                 <div class="col-md-9 col-sm-12">
                                                   <asp:DropDownList dbcolumn="group_id"  SkinID="form-control" class="form-control" ClientIDMode="Static" ID="ddlgroup_id" runat="server"> </asp:DropDownList>
                                                  </div>
                                                  </div>
                                               <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-md-3 col-sm-12">
                                                    <label class="required">الإدارة</label>
                                                </div>
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:DropDownList dbcolumn="managment_id" required SkinID="form-control" class="form-control" ClientIDMode="Static" ID="ddlmanagment_id" runat="server">
                                                    </asp:DropDownList>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:TextBox SkinID="form-control" class="form-control"   TextMode="Password" dbColumn="User_Password" ClientIDMode="Static" ID="txtUserPassword" runat="server">
                                                    </asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 col-sm-12">
                                                    <asp:TextBox SkinID="form-control" class="form-control" required dbColumn="User_PhoneNumber" ClientIDMode="Static" ID="TextBox3" runat="server">
                                                    </asp:TextBox>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3 col-sm-12">
                                                    <div id="divcomp_id" runat="server">
                                                        <label class="required">اسم الجمعية</label>
                                                    ...
                                                    <div class="col-md-9 col-sm-12">
                                                         ...
                                                         <asp:DropDownList SkinID="form-control" class="form-control" dbColumn="comp_id" ClientIDMode="Static" ID="ddlcomp_id" runat="server">
                                                          </asp:DropDownList>
                                                        <i class="fancy-arrow"></i>
                                                    </div>
                                                </div>
