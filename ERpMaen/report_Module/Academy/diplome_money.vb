...
Public Class diplome_money
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.diplome_money.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddiplome_money
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As diplome_money = New diplome_money()
        rpt.Site = Me.Site
        Return rpt
    End Function
