...
Public Class course_attendence
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.course_attendence.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcourse_attendence
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As course_attendence = New course_attendence()
        rpt.Site = Me.Site
        Return rpt
    End Function
