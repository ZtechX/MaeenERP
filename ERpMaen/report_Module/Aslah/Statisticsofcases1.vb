...
Public Class Statisticsofcases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.Statisticsofcases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatisticsofcases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Statisticsofcases = New Statisticsofcases()
        rpt.Site = Me.Site
        Return rpt
    End Function
