...
Public Class ReviewRep
    ...
    Private Sub getReportData(ByVal details_id As String, ByVal type As String, ByVal person_id As String, ByVal _date As String)
        Try
            ...
            Dim query = "SELECT persons.name FROM ash_case_receiving_delivery_details details left join ash_case_persons persons on details." + type + "=persons.id where details.deleted !=1 and details.id=" + details_id
