...
Public Class RegistAggregation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.RegistAggregation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistAggregation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegistAggregation = New RegistAggregation()
        rpt.Site = Me.Site
        Return rpt
    End Function
