...
Public Class AttendanceRegistRep
  ...
  where  ash_case_sessions.id=" + session_id
                ...
                If dt1.Rows.Count <> 0 Then
                    ...
                    rdoc.SetParameterValue("img_footer_URL", dt1.Rows(0)("img_footer").ToString, "subReportAttendance.rpt")
                Else
                    rdoc.SetParameterValue("img_header_URL", "")
                    rdoc.SetParameterValue("img_footer_URL", "", "subReportAttendance.rpt")
