...
Public Class TechRepForMembers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.TechRepForMembers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTechRepForMembers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TechRepForMembers = New TechRepForMembers()
        rpt.Site = Me.Site
        Return rpt
    End Function
