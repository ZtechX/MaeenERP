...
Public Class AttendanceRegist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.AttendanceRegist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAttendanceRegist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AttendanceRegist = New AttendanceRegist()
        rpt.Site = Me.Site
        Return rpt
    End Function
