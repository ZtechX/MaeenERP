...
Public Class ReceiveProceeding
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.ReceiveProceeding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReceiveProceeding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReceiveProceeding = New ReceiveProceeding()
        rpt.Site = Me.Site
        Return rpt
    End Function
