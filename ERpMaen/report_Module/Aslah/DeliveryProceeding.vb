...
Public Class DeliveryProceeding
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERpMaen.DeliveryProceeding.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeliveryProceeding
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DeliveryProceeding = New DeliveryProceeding()
        rpt.Site = Me.Site
        Return rpt
    End Function
