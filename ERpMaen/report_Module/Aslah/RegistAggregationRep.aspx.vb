...
Public Class RegistAggregationRep
...
persons2.name as 'PAgainst',date_h,notes,persons2.indenty as 'PAgainst_num'
 FROM ash_case_conciliation 
  ...
  where ash_case_conciliation.id=" + Conc_id
            ...
            If dt2.Rows.Count <> 0 Then
                Dim ds As New RegistAggregationDS
                ...
                ds.Tables("Details").Rows(0).Item("Pfrom_num") = dt2.Rows(0).Item("Pfrom_num").ToString
                ds.Tables("Details").Rows(0).Item("PAgainst_num") = dt2.Rows(0).Item("PAgainst_num").ToString
