...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function _fnColumnIndex(iColumnIndex) {
            ...
            // ** this code already was commented ** //
            //return iColumnIndex;
        ...
        function SetValueFormat(sender) {
            if (sender != "") {
                if (sender.indexOf(",") > -1) {
                    sender = sender.replace(/,/g, "");
                    sender = parseFloat(sender) * 1;
                }
                else {
                    sender = parseFloat(sender) * 1;
                }
        ...
        function fnCreateRangeInput(oTable) {
            ...
            */
            ...
            function (oSettings, aData, iDataIndex) {
                ...
                iMin = SetValueFormat(iMin);

                var iMax = document.getElementById(sToId).value;
                iMax = SetValueFormat(iMax);

                //var iValue = aData[_fnColumnIndex(index)] == "-" ? 0 : aData[_fnColumnIndex(index)] * 1;
                var iValue = aData[_fnColumnIndex(index)] == "-" ? 0 : aData[_fnColumnIndex(index)];
                iValue = SetValueFormat(iValue);
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected) {
            ...
            var r = '<select class="search_init select_filter"><option value="" class="search_init"> -- Select-- </option>';
            var j = 0;
            ...
            select.change(function () {
                ...
                if (bRegex)
                    ...
                    oTable.fnFilter(unescape("^" + $(this).val() + "$"), iColumn, true, false); //Issue 25
                fnOnFiltered();
            });
            if (currentFilter != null && currentFilter != "")//Issue 81
