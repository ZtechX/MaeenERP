...
DynaTreeNode.prototype = {
	...
	_getInnerHtml: function() {
		...
		if ( data.icon ) {
			if (data.icon.charAt(0) === "../default.htm"){
				imageSrc = data.icon;
			}else{
...
//		}
	...
	_loadKeyPath: function(keyPath, callback) {
		...
		if(segList[0] === ""){
			throw "Key path must be relative (don't start with '../default.htm')";
		}
			...
			$("script").each( function () {
				...
				if( this.src.search(_rexDtLibName) >= 0 ) {
					if( this.src.indexOf("/")>=0 ){ // issue #47
						opts.imagePath = this.src.slice(0, this.src.lastIndexOf("/")) + "../skin/default.htm";
					}else{
						opts.imagePath = "skin/";
					}
...
//		helper: null,
	...
	keyPathSeparator: "../default.htm", // Used by node.getKeyPath() and tree.loadKeyPath().
//    cookieId: "dynatree-cookie", // Choose a more unique name, to allow multiple trees.
	cookieId: "dynatree", // Choose a more unique name, to allow multiple trees.
	cookie: {
		expires: null //7, // Days or Date; null: session cookie
//		path: "../default.htm", // Defaults to current page
//		domain: "jquery.com",
//		secure: true
	},
