    ...
    Public Function Save(ByVal id As String, ByVal basicDataJson As Dictionary(Of String, Object)) As Boolean
        Try
            ...
            Dim dictBasicDataJson As Dictionary(Of String, Object) = basicDataJson
                ...
                If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "tblsms_settings", id, _sqlconn, _sqltrans) Then
                    _sqltrans.Commit()
                    _sqlconn.Close()
                    Return True
                Else
...
#Region "get_data"
    ...
    Public Function get_data(ByVal comp_id As String) As String()
        ...
        Try
            ...
            dt = DBManager.Getdatatable("select * from tblsms_settings where comp_id=" + comp_id)
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("tblsms_settings", editItemId)
            Names.Add("1")
            Names.Add(str)
            Return Names.ToArray
        Catch ex As Exception
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "tblsms_settings") Then
                Names.Add("1")
