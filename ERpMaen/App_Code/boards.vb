...
#Region "save"
    ...
    Public Function save(ByVal id As String, ByVal basicDataJson As Object) As Boolean
        ...
        Try
            ...
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "tblboards", id, _sqlconn, _sqltrans) Then
                _sqltrans.Commit()
                _sqlconn.Close()
                Return True
            Else
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("tblboards", editItemId)
            Names.Add("1")
            Names.Add(str)
            Return Names.ToArray
        Catch ex As Exception
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        ...
        Dim dt As DataTable
        Try
            dt = DBManager.Getdatatable("select * from tblboards where id=" + deleteItem.ToString())
            If dt.Rows(0).Item("type").ToString <> 1 Then
                If PublicFunctions.DeleteFromTable(deleteItem, "tblboards") Then
