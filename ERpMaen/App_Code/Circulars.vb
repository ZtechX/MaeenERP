...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Try
            ...
            Dim str1 As String = ""
            dtattch_file = DBManager.Getdatatable("Select * from tblImages where Source='Circulars' and isnull(deleted,0)=0  and Source_id=" + editItemId.ToString())
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        ...
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "tblletter") Then
                DBManager.ExcuteQuery("delete from tblImages where Source_id=" + deleteItem.ToString + " and Source='Circulars' ")
                Names.Add("1")
...
#End Region
    ...
    Private Function Savea_ttch_file(ByVal attch_file_DataJsonList As List(Of Object), ByVal letter_Id As String) As Boolean
        Try
            DBManager.ExcuteQuery("delete from tblImages where Source_id=" + letter_Id.ToString + " and Source='Circulars' ")
    ...
    Public Function getBarCode() As String
        ...
        Dim val = ""
        dt = DBManager.Getdatatable("SELECT isNull (parcode,'') parcode FROM tblletter where id= (select max(id) from tblletter where type= 5)")
