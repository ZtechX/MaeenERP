...
#Region "Save"
    ...
    Public Function SaveSemester(ByVal id As String, ByVal basicDataJson As Object) As String
        Try
            _sqlconn.Open()
            ...
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "acd_semester", id, _sqlconn, _sqltrans) Then
                success = True
            Else
                success = False
...
#Region "get_data"
    ...
    Public Function get_data(ByVal comp_id As String) As String()
        ...
        Try
            ...
            dt = DBManager.Getdatatable("select * from acd_semester where comp_id=" + comp_id)
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("acd_semester", editItemId)
            Names.Add("1")
            Names.Add(str)
            Return Names.ToArray
        Catch ex As Exception
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "acd_semester") Then
                Names.Add("1")
