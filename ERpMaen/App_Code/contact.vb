...
#Region "Save"
    ...
    Public Function Save(ByVal id As String, ByVal basicDataJson As Object) As Boolean
        Try
            ...
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "tblcontacts", id, _sqlconn, _sqltrans) Then
                _sqltrans.Commit()
                _sqlconn.Close()
                Return True
            Else
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("tblcontacts", editItemId)
            Names.Add("1")
            Names.Add(str)
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "tblcontacts") Then
                Names.Add("1")
