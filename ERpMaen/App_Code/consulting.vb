...
#Region "get Conslute_messages"
    ...
    Public Function getConsluteMess(ByVal id As String) As String
        Try
            Dim dt As New DataTable
            dt = DBManager.Getdatatable("select message,message_date, full_name from ash_consulting_messages left join tblUsers on user_from =tblUsers.id  where consulting_id=" + id)
            If dt.Rows.Count <> 0 Then
