...
#Region "Save"
    ...
    Public Function Save(ByVal id As String, ByVal basicDataJson As Dictionary(Of String, Object)) As Boolean
        Try
            ...
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "acd_acadmies", id, _sqlconn, _sqltrans) Then
                If Not PublicFunctions.TransUsers_logs("2161", "acd_acadmies", "ادخال", _sqlconn, _sqltrans) Then
                    success = False
                Else
                    success = True
                End If
...
#Region "get_data"
    ...
    Public Function get_data(ByVal comp_id As String) As String()
        ...
        Try
            ...
            dt = DBManager.Getdatatable("select * from acd_acadmies where comp_id=" + comp_id)
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("acd_acadmies", editItemId)
            Names.Add("1")
            Names.Add(str)
            If Not PublicFunctions.TransUsers_logs("2161", "acd_acadmies", "تعديل", _sqlconn, _sqltrans) Then
                success = False
            Else
                success = True
            End If
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "acd_acadmies") Then
                Names.Add("1")
                Names.Add("تم الحذف بنجاح!")
                If Not PublicFunctions.TransUsers_logs("2161", "acd_acadmies", "حذف", _sqlconn, _sqltrans) Then
                    success = False
                Else
                    success = True
                End If
