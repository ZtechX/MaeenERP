...
Public Class Archived_DiplomaSubjectDetailsCls
...
#Region "update archive"
    ...
    <WebMethod()>
    <System.Web.Script.Services.ScriptMethod()>
    Public Function unArchive_course(ByVal subjectId As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If DBManager.ExcuteQuery("update acd_diplome_subjects set archive=0 where id=" + subjectId) <> -1 Then
                If Not PublicFunctions.TransUsers_logs("4208", "acd_diplome_subjects", "ارشيف", _sqlconn, _sqltrans) Then
                    success = False
                Else
                    success = True
                End If
