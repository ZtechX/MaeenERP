    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Page.IsPostBack = False Then
                ...
                '  
                Dim clsddltype2 As New clsFillComboByDataSource("select * from tbllock_up where ISNUll(deleted,0)=0 and type='JD'", "description", "id", "")
                clsddltype2.SetComboItems(job_id, "", True, "--اختر--", False)
