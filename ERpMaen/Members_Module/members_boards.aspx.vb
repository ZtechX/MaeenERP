    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Page.IsPostBack = False Then
                ...
                Dim comp = get_admin()
                Dim clsddltype4 As New clsFillComboByDataSource("select * from tblboards where ISNUll(deleted,0)=0 and comp_id=" + comp.ToString, "name", "id", "")
                clsddltype4.SetComboItems(board_id, "", True, "--اختر--", False)
