...
var deleteWebServiceMethod = "trainersCls.asmx/Delete";
// global variable used in row_click and update functions
var editWebServiceMethod = "trainersCls.asmx/Edit";
...
function save() {
    ...
    try {
        ...
        if (Page_ClientValidate("vgroup")) {
            ...
            trainersCls.SaveUser(PosId, basicData, function (val) {
...
function drawDynamicTable() {
    try {
        ...
        loadDynamicTable('Trainers', "AutoCodeHide", tableColumnDefs, tableFilteringColumns, tableSortingColumns, initialSortingColumn, "Form");
    } catch (err) {
        //alert(err);
    }
}
