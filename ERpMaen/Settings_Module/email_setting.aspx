    ...
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            ...
            <div class="wraper">
                ...
                <div>
                    <script src="../JS_Code/email_setting/email_setting.js"></script>
                    <%--                  <script src="../JS_Code/email_setting/halls_Save.js"></script>
                    <script src="../JS_Code/email_setting/halls_Edit.js"></script>
                    <script src="../JS_Code/email_setting/halls_Upload.js"></script>--%>
                </div>
                <div>
                        ...
                        <div class="cp_margin pad10">
                            ...
                            <asp:Panel ID="pnlForm" runat="server">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-12">
                                            <label for="Name" class="label-required">البريد الإلكترونى</label>

                                        </div>
                                        <div class="col-md-9 col-sm-12">
                                            <asp:TextBox SkinID="form-control" class="form-control" dbcolumn="email" type="email" ID="Text1"  ClientIDMode="Static"  runat="server">
                                            </asp:TextBox>

                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Text1"
                                                ErrorMessage="من فضلك أدخل البريد الإلكترونى " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="row">
                                        <br />
                                        <div class="col-md-3 col-sm-12">
                                            <label for="TextBox1">البروتوكول </label>
                                        </div>
                                        <div class="col-md-9 col-sm-12">
                                            <asp:TextBox SkinID="form-control" class="form-control" dbcolumn="smtp" ClientIDMode="Static" ID="Textdetails" runat="server">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Textdetails"
                                                ErrorMessage="من فضلك أدخل البروتوكول " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="row">
                                        <br />
                                        <div class="col-md-3 col-sm-12">
                                            <label for="email">أمن </label>
                                        </div>
                                        <div class="col-md-3 col-sm-12">
                                            <input dbcolumn="security" type="checkbox" id="active" style="width: 40px;" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-12">
                                            <label for="TextBox1">كلمة السر  </label>

                                        </div>
                                        <div class="col-md-9 col-sm-12">
                                            <asp:TextBox SkinID="form-control" class="form-control" dbcolumn="pass" type="password" ClientIDMode="Static" ID="TextBox2" runat="server">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
                                                ErrorMessage="من فضلك أدخل كلمة السر " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="row">
                                        <br />
                                        <div class="col-md-3 col-sm-12">
                                            <label for="TextBox1">رقم البورت </label>

                                        </div>
                                        <div class="col-md-9 col-sm-12">
                                            <asp:TextBox SkinID="form-control" class="form-control" dbcolumn="port_no" ClientIDMode="Static" ID="TextBox3" runat="server">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3"
                                                ErrorMessage="من فضلك أدخل رقم البورت " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
