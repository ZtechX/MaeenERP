...
//    Dashboard_OMS.GetToDoListItems(function (val) {

//        var data = JSON.parse(val[1]);
//        var div_show = "";
//        for (var x = 0; x < data.length; x++) {

//            div_show += "<li class='list-group-item'><div class='checkbox checkbox-primary'><input class='todo-done' id='" + data[x].id + "' type='checkbox' checked><label for='" + data[x].id + "'>" + data[x].note + "</label></div></li>";
//        }
//        $('#todo-list').html(div_show);
//    });
