<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Students.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.Students" Theme="Theme5" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="content">
    <asp:ScriptManager ID="ToolkitScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/ASMX_WebServices/studentCls.asmx" />
    ...
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            ...
            <div class="wraper">
                ...
                <div>
                    <script src="../JS_Code/acadmies/student.js"></script>
                ...
                <div>
                    <div class="main-title">
                        <asp:Label ID="lblFormName" runat="server" Text="الطلاب" SkinID="page_title"></asp:Label>
                    </div>
                                    ...
                                    <div class=" row form-group">
                                        ...
                                        <div class="col-md-9 col-sm-12">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Name"
                                                ErrorMessage="من فضلك أدخل اسم الطالب " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
