...
function onUploadFileComplete(sender, args) {
    try {
        ...
        var folders = "Settings_Module/images_register_company"
...
//        var folders = "Projects_Module/Images"
...
function deleteUploadedFile(val) {
    try {
        MultiFileUploader.DeleteFile(val, "Settings_Module", onSuccessDeletedFile);
    } catch (err) {
        alert(err);
    }
}
