...
var deleteWebServiceMethod = "acadmiy.asmx/Delete";
// global variable used in row_click and update functions
var editWebServiceMethod = "acadmiy.asmx/Edit";
...
function save() {
    ...
    try {
        ...
        if (Page_ClientValidate("vgroup")) {
            ...
            acadmiy.Save(PosId, basicData, function (val) {
                if (val == true) {
                    debugger;
...
function drawDynamicTable() {
    try {
        ...
        loadDynamicTable('acadmey', "AutoCodeHide", tableColumnDefs, tableFilteringColumns, tableSortingColumns, initialSortingColumn, "Form");
    } catch (err) {
        alert(err);
    }
}
