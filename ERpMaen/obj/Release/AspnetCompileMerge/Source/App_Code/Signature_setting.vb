...
Public Class Signature_setting
...
#Region "Save"
    ...
    Public Function Save(ByVal id As String, ByVal basicDataJson As Dictionary(Of String, Object), ByVal image As String) As Boolean
        Try

            _sqlconn.Open()
            _sqltrans = _sqlconn.BeginTransaction
            Dim dictBasicDataJson As Dictionary(Of String, Object) = basicDataJson
            dictBasicDataJson.Add("image", image)
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "tblsign_settings", id, _sqlconn, _sqltrans) Then
                _sqltrans.Commit()
                _sqlconn.Close()
                Return True
            Else
...
#Region "get_data"
    ...
    Public Function get_data(ByVal comp_id As String) As String()
        ...
        Try
            ...
            dt = DBManager.Getdatatable("select * from tblsign_settings where comp_id=" + comp_id)
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("tblsign_settings", editItemId)
            Names.Add("1")
            Names.Add(str)
            Return Names.ToArray
        Catch ex As Exception
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "tblsign_settings") Then
                Names.Add("1")
