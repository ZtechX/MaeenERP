...
#Region "Save"
    ...
    Public Function Save(ByVal id As String, ByVal basicDataJson As Dictionary(Of String, Object)) As Boolean
        Try
            ...
            If PublicFunctions.TransUpdateInsert(dictBasicDataJson, "tblemail_settings", id, _sqlconn, _sqltrans) Then
                _sqltrans.Commit()
                _sqlconn.Close()
                Return True
            Else
...
#Region "get_data"
    ...
    Public Function get_data(ByVal comp_id As String) As String()
        ...
        Try
            ...
            dt = DBManager.Getdatatable("select * from tblemail_settings where comp_id=" + comp_id)
...
#Region "Edit"
    ...
    Public Function Edit(ByVal editItemId As String) As String()
        ...
        Dim Names As New List(Of String)(10)
        Try
            Dim str As String = PublicFunctions.GetDataForUpdate("tblemail_settings", editItemId)
            Names.Add("1")
            Names.Add(str)
            Return Names.ToArray
        Catch ex As Exception
...
#Region "Delete"
    ...
    Public Function Delete(ByVal deleteItem As String) As String()
        Dim Names As New List(Of String)(10)
        Try
            If PublicFunctions.DeleteFromTable(deleteItem, "tblemail_settings") Then
                Names.Add("1")
