...
function HijriDate(year, month, date, hour, minute, second, millisecond) {
    ...
    function updateDate() {
        var tm = (time+9*60*60*1000) - HijriDate.constInterval,
            range;
...
HijriDate.monthShortNames = ['محر', 'صفر', 'ربع1', 'ربع2', 'جم1', 'جم2', 'رجب', 'شعب', 'رمض', 'شوا', 'قعد', 'حجة'];

HijriDate.weekdayNames = [ "السبت","الاحد", "الاثنين", "الثلاثاء", "الاربعاء", "الخميس", "الجمعة"];

HijriDate.weekdayShortNames = ['سبت','احد', 'اثن', 'ثلا', 'ارب', 'خمي', 'جمع' ];
