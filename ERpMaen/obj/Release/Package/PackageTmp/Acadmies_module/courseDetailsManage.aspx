<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="courseDetailsManage.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.courseDetailsManage" %>
                                    ...
                                    <div class="inner">
                                        <div class="edit-order">
                                           ...
                                           <%-- <button type="button" class="btn btn_rate btn-warning" data-toggle="modal" data-target="#order_rate">
                                                    <i class="zmdi zmdi-star"></i>تقييم الدورة</button>--%>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="#">
                                ...
                                <div class="form-group">
                                    <label for="p_dd">مدرب الدورة  </label>
                                    <input type="text" class="form-control" id="p_dd"/>
                                </div>
