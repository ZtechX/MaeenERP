<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="boards.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.boards" Theme="Theme5"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="content">
    <asp:ScriptManager  ID="ToolkitScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/ASMX_WebServices/boards.asmx" />
    ...
    border: 1px solid gainsboro;
        ...
        #divAreaList1{    max-height: 200px; overflow: auto;}
                ...
                <div>
                    <script src="../JS_Code/boards/boards.js"></script>
                         </div>
                <div>
                            ...
                            <asp:Panel ID="pnlForm" runat="server">
                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                 ...
                                                 <label for="Name" class="label-required">اسم المجلس</label>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Name"
                                                    ErrorMessage="من فضلك أدخل اسم المجلس " ValidationGroup="vgroup"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="row">
                                                <br />
                                                <div class="col-md-3 col-sm-12">
                                                    <label for="TextBox1"> عدد الاعضاء </label>
                                                    </div>
                                                <div class="col-md-9 col-sm-12">
                                                <asp:TextBox SkinID="form-control" class="form-control"  dbColumn="members_number" ClientIDMode="Static" ID="Textdetails" runat="server">
                                                </asp:TextBox>
                                                    </div>
