<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="members_boards.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.members_boards" Theme="Theme5" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="content">
    <asp:ScriptManager ID="ToolkitScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/ASMX_WebServices/members_boards.asmx" />
            ...
            <div class="wraper">
                ...
                <div>
                    <div class="main-title">
                        <asp:Label ID="lblFormName" runat="server" Text="اعضاء المجلس" SkinID="page_title"></asp:Label>
                    </div>
                    ...
                    <div id="divForm" class="newformstyle form_continer">
                        ...
                        <asp:Label ID="Label2" ClientIDMode="Static" Style="display: none" runat="server" dbColumn="id"></asp:Label>
                        <asp:TextBox runat="server" ID="TextBox1" Style="display: none"></asp:TextBox>
                        <asp:Label ID="Label3" ClientIDMode="Static" Style="display: none" runat="server" dbcolumn="project_id"></asp:Label>
                        <asp:Label ID="Label4" ClientIDMode="Static" Style="display: none" runat="server" dbcolumn=""></asp:Label>
                        <asp:Label ID="Label5" ClientIDMode="Static" Style="display: none" runat="server" dbcolumn=""></asp:Label>
                        <asp:Label ClientIDMode="Static" runat="server" Style="display: none" ID="Label6">1</asp:Label>
                        <asp:Label ClientIDMode="Static" runat="server" Style="display: none" ID="Label7">1</asp:Label>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <br />
                                            <button class="btn btn-primary" id="all_member" onclick="save_member_boards(); return false;">
                                                حفظ                          
                                            </button>
                                        </div>
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div style="max-height: 300px; overflow: auto;">
                                                ...
                                                <button class="btn btn-danger" id="some_member" onclick="disapproved(); return false;">حذف العضو المجلس</button>
