            ...
            <div class="wraper">
                ...
                <div>
                    <div class="main-title">
                        <asp:Label ID="lblFormName" runat="server" Text="الاستشارات" SkinID="page_title"></asp:Label>
...
<div class="col-md-6">
      ...
      <label class="col-md-12" id="gander"></label>
                                                    ...
                                                    <div class="panel panel-default" id="divCollapse2">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
                                        ...
                                        <div class="col-md-9 col-sm-12">
                                            <input onkeypress="return cust_chkNumber(event,this,10);" dbcolumn="identiy" type="text" id="TextNUMId"
                                                class="form-control" runat="server" clientidmode="Static" />
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <label class="label-required">الجنسية </label>
                                                                                ...
                                                                                <div class="col-md-9 col-sm-12">
                                            <asp:DropDownList dbcolumn="nationality_id" class="form-control" ClientIDMode="Static" ID="ddlnationality" runat="server">
                                            </asp:DropDownList>
                                            <br />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-12">
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                             <label>إظهار البيانات</label>
  </div>
                                    <div class="col-md-9 col-sm-12">

                                        <label class="switch switch-success">
                                            <input  id="appear_data"   runat="server" type="checkbox" />
                                                    ...
                                                    <div class="panel panel-default" id="divCollapse3">
                                                        <div class="panel-heading">
                                                            <h4 class="panel-title">
