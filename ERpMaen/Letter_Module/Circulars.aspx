<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Circulars.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.Circulars" Theme="Theme5"%>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="content">
    <asp:ScriptManager  ID="ToolkitScriptManager1" runat="server">
        <Services>
            <asp:ServiceReference Path="~/ASMX_WebServices/Circulars.asmx" />
  ...
  <%--                  <script src="../JS_Code/sessions/halls_Save.js"></script>
                ...
                <div>
                    <div class="main-title">
                        <asp:Label ID="lblFormName" runat="server" Text="التعاميم" SkinID="page_title"></asp:Label>
                    </div>
                            ...
                            <asp:Panel ID="pnlForm" runat="server">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <br />
                                        <div class="col-md-3 col-sm-12">
                                            <label for="TextBox1" class="label-required">عنوان التعاميم  </label>
                                        </div>
                                        <div class="col-md-9 col-sm-12">
                                            <asp:TextBox runat="server" required ClientIDMode="Static" dbColumn="title" ID="txtname_ar" placeholder="" SkinID="form-control" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        <br />
                                        <div class="col-md-3 col-sm-12">
                                            <label for="TextBox1">تفاصيل التعاميم </label>
                                        </div>
                                        <div class="col-md-9 col-sm-12">
