<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="out_inside_letters.aspx.vb" MasterPageFile="~/Site.Master" Inherits="ERpMaen.out_inside_letters" Theme="Theme5"%>
  ...
  <%--                  <script src="../JS_Code/sessions/halls_Save.js"></script>
                ...
                <div>
                    <div class="main-title">
                        <asp:Label ID="lblFormName" runat="server" Text="الخطابات الصادرة" SkinID="page_title"></asp:Label>
                    </div>
